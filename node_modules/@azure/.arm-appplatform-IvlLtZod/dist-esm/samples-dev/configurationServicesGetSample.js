 ...
 */
function configurationServicesGet() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.configurationServices.get(resourceGroupName, serviceName, configurationServiceName);
        console.log(result);
    });
}
configurationServicesGet().catch(console.error);
//# sourceMappingURL=configurationServicesGetSample.js.map