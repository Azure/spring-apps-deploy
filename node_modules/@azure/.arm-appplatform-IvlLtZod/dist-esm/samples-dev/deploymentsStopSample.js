...
function deploymentsStop() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.deployments.beginStopAndWait(resourceGroupName, serviceName, appName, deploymentName);
        console.log(result);
    });
}
deploymentsStop().catch(console.error);
//# sourceMappingURL=deploymentsStopSample.js.map