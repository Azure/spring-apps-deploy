 ...
 */
function buildpackBindingCreateOrUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const buildpackBinding = {
            properties: {
                ...
                launchProperties: {
                    ...
                    secrets: {
                        connectionString: "XXXXXXXXXXXXXXXXX=XXXXXXXXXXXXX-XXXXXXXXXXXXXXXXXXX;XXXXXXXXXXXXXXXXX=XXXXXXXXXXXXXXXXXXX"
                    }
                }
            }
        };
        ...
        const result = yield client.buildpackBinding.beginCreateOrUpdateAndWait(resourceGroupName, serviceName, buildServiceName, builderName, buildpackBindingName, buildpackBinding);
        console.log(result);
    });
}
buildpackBindingCreateOrUpdate().catch(console.error);
//# sourceMappingURL=buildpackBindingCreateOrUpdateSample.js.map