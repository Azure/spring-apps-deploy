 ...
 */
function servicesEnableTestEndpoint() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.services.enableTestEndpoint(resourceGroupName, serviceName);
        console.log(result);
    });
}
servicesEnableTestEndpoint().catch(console.error);
//# sourceMappingURL=servicesEnableTestEndpointSample.js.map