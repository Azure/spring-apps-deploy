...
import { DeploymentResource, DeploymentsListOptionalParams, DeploymentsListForClusterOptionalParams, DeploymentsGetOptionalParams, DeploymentsGetResponse, DeploymentsCreateOrUpdateOptionalParams, DeploymentsCreateOrUpdateResponse, DeploymentsDeleteOptionalParams, DeploymentsUpdateOptionalParams, DeploymentsUpdateResponse, DeploymentsStartOptionalParams, DeploymentsStopOptionalParams, DeploymentsRestartOptionalParams, DeploymentsEnableRemoteDebuggingOptionalParams, DeploymentsEnableRemoteDebuggingResponse, DeploymentsDisableRemoteDebuggingOptionalParams, DeploymentsDisableRemoteDebuggingResponse, DeploymentsGetRemoteDebuggingConfigOptionalParams, DeploymentsGetRemoteDebuggingConfigResponse, DeploymentsGetLogFileUrlOptionalParams, DeploymentsGetLogFileUrlResponse, DiagnosticParameters, DeploymentsGenerateHeapDumpOptionalParams, DeploymentsGenerateThreadDumpOptionalParams, DeploymentsStartJFROptionalParams } from "../models";
...
export declare class DeploymentsImpl implements Deployments {
    ...
    private listForClusterPagingPage;
    private listForClusterPagingAll;
    /**
