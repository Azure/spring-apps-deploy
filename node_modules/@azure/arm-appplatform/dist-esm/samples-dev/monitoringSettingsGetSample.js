 ...
 */
function monitoringSettingsGet() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.monitoringSettings.get(resourceGroupName, serviceName);
        console.log(result);
    });
}
monitoringSettingsGet().catch(console.error);
//# sourceMappingURL=monitoringSettingsGetSample.js.map