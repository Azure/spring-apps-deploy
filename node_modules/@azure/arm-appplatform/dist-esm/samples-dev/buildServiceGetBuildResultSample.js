 ...
 */
function buildServiceGetBuildResult() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.buildServiceOperations.getBuildResult(resourceGroupName, serviceName, buildServiceName, buildName, buildResultName);
        console.log(result);
    });
}
buildServiceGetBuildResult().catch(console.error);
//# sourceMappingURL=buildServiceGetBuildResultSample.js.map