 ...
 */
function runtimeVersionsListRuntimeVersions() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["APPPLATFORM_SUBSCRIPTION_ID"] ||
            "00000000-0000-0000-0000-000000000000";
        const credential = new DefaultAzureCredential();
        const client = new AppPlatformManagementClient(credential, subscriptionId);
        const result = yield client.runtimeVersions.listRuntimeVersions();
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=runtimeVersionsListRuntimeVersionsSample.js.map