 ...
 */
function buildServiceAgentPoolUpdatePut() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.buildServiceAgentPool.beginUpdatePutAndWait(resourceGroupName, serviceName, buildServiceName, agentPoolName, agentPoolResource);
        console.log(result);
    });
}
buildServiceAgentPoolUpdatePut().catch(console.error);
//# sourceMappingURL=buildServiceAgentPoolUpdatePutSample.js.map