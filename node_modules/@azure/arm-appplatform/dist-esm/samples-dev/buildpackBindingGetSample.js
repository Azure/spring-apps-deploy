...
function buildpackBindingGet() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.buildpackBinding.get(resourceGroupName, serviceName, buildServiceName, builderName, buildpackBindingName);
        console.log(result);
    });
}
buildpackBindingGet().catch(console.error);
//# sourceMappingURL=buildpackBindingGetSample.js.map