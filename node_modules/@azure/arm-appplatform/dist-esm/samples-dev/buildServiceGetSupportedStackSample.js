 ...
 */
function buildServiceGetSupportedStack() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.buildServiceOperations.getSupportedStack(resourceGroupName, serviceName, buildServiceName, stackName);
        console.log(result);
    });
}
buildServiceGetSupportedStack().catch(console.error);
//# sourceMappingURL=buildServiceGetSupportedStackSample.js.map