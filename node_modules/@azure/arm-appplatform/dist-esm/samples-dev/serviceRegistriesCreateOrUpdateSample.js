 ...
 */
function serviceRegistriesCreateOrUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.serviceRegistries.beginCreateOrUpdateAndWait(resourceGroupName, serviceName, serviceRegistryName);
        console.log(result);
    });
}
serviceRegistriesCreateOrUpdate().catch(console.error);
//# sourceMappingURL=serviceRegistriesCreateOrUpdateSample.js.map