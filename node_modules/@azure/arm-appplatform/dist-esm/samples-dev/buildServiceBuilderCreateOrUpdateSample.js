 ...
 */
function buildServiceBuilderCreateOrUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.buildServiceBuilder.beginCreateOrUpdateAndWait(resourceGroupName, serviceName, buildServiceName, builderName, builderResource);
        console.log(result);
    });
}
buildServiceBuilderCreateOrUpdate().catch(console.error);
//# sourceMappingURL=buildServiceBuilderCreateOrUpdateSample.js.map