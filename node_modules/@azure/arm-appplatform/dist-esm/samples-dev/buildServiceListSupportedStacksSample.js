 ...
 */
function buildServiceListSupportedStacks() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.buildServiceOperations.listSupportedStacks(resourceGroupName, serviceName, buildServiceName);
        console.log(result);
    });
}
buildServiceListSupportedStacks().catch(console.error);
//# sourceMappingURL=buildServiceListSupportedStacksSample.js.map