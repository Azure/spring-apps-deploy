 ...
 */
function buildServiceBuilderGet() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.buildServiceBuilder.get(resourceGroupName, serviceName, buildServiceName, builderName);
        console.log(result);
    });
}
buildServiceBuilderGet().catch(console.error);
//# sourceMappingURL=buildServiceBuilderGetSample.js.map