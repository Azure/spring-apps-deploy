 ...
 */
function buildServiceGetSupportedBuildpack() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.buildServiceOperations.getSupportedBuildpack(resourceGroupName, serviceName, buildServiceName, buildpackName);
        console.log(result);
    });
}
buildServiceGetSupportedBuildpack().catch(console.error);
//# sourceMappingURL=buildServiceGetSupportedBuildpackSample.js.map