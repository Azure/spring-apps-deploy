 ...
 */
function appsSetActiveDeployments() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.apps.beginSetActiveDeploymentsAndWait(resourceGroupName, serviceName, appName, activeDeploymentCollection);
        console.log(result);
    });
}
appsSetActiveDeployments().catch(console.error);
//# sourceMappingURL=appsSetActiveDeploymentsSample.js.map