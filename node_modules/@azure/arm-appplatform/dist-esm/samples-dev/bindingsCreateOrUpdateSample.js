 ...
 */
function bindingsCreateOrUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.bindings.beginCreateOrUpdateAndWait(resourceGroupName, serviceName, appName, bindingName, bindingResource);
        console.log(result);
    });
}
bindingsCreateOrUpdate().catch(console.error);
//# sourceMappingURL=bindingsCreateOrUpdateSample.js.map