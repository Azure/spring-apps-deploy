...
function deploymentsUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.deployments.beginUpdateAndWait(resourceGroupName, serviceName, appName, deploymentName, deploymentResource);
        console.log(result);
    });
}
/**
 ...
 */
function deploymentsUpdateCustomContainer() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["APPPLATFORM_SUBSCRIPTION_ID"] ||
            "00000000-0000-0000-0000-000000000000";
        const resourceGroupName = process.env["APPPLATFORM_RESOURCE_GROUP"] || "myResourceGroup";
