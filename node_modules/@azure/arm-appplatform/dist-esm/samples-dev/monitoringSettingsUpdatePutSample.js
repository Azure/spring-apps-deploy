 ...
 */
function monitoringSettingsUpdatePut() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.monitoringSettings.beginUpdatePutAndWait(resourceGroupName, serviceName, monitoringSettingResource);
        console.log(result);
    });
}
monitoringSettingsUpdatePut().catch(console.error);
//# sourceMappingURL=monitoringSettingsUpdatePutSample.js.map