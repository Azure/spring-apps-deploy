 ...
 */
function gatewaysValidateDomain() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.gateways.validateDomain(resourceGroupName, serviceName, gatewayName, validatePayload);
        console.log(result);
    });
}
gatewaysValidateDomain().catch(console.error);
//# sourceMappingURL=gatewaysValidateDomainSample.js.map