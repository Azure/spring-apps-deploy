 ...
 */
function configServersValidate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.configServers.beginValidateAndWait(resourceGroupName, serviceName, configServerSettings);
        console.log(result);
    });
}
configServersValidate().catch(console.error);
//# sourceMappingURL=configServersValidateSample.js.map