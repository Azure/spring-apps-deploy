...
function customDomainsUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.customDomains.beginUpdateAndWait(resourceGroupName, serviceName, appName, domainName, domainResource);
        console.log(result);
    });
}
customDomainsUpdate().catch(console.error);
//# sourceMappingURL=customDomainsUpdateSample.js.map