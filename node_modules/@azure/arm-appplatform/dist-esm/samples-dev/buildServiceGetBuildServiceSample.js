 ...
 */
function buildServiceGetBuildService() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.buildServiceOperations.getBuildService(resourceGroupName, serviceName, buildServiceName);
        console.log(result);
    });
}
buildServiceGetBuildService().catch(console.error);
//# sourceMappingURL=buildServiceGetBuildServiceSample.js.map