 ...
 */
function apiPortalCustomDomainsDelete() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.apiPortalCustomDomains.beginDeleteAndWait(resourceGroupName, serviceName, apiPortalName, domainName);
        console.log(result);
    });
}
apiPortalCustomDomainsDelete().catch(console.error);
//# sourceMappingURL=apiPortalCustomDomainsDeleteSample.js.map