 ...
 */
function configServersUpdatePut() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.configServers.beginUpdatePutAndWait(resourceGroupName, serviceName, configServerResource);
        console.log(result);
    });
}
configServersUpdatePut().catch(console.error);
//# sourceMappingURL=configServersUpdatePutSample.js.map