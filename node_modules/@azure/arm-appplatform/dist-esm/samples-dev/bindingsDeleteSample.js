...
function bindingsDelete() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.bindings.beginDeleteAndWait(resourceGroupName, serviceName, appName, bindingName);
        console.log(result);
    });
}
bindingsDelete().catch(console.error);
//# sourceMappingURL=bindingsDeleteSample.js.map