...
function servicesListTestKeys() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.services.listTestKeys(resourceGroupName, serviceName);
        console.log(result);
    });
}
servicesListTestKeys().catch(console.error);
//# sourceMappingURL=servicesListTestKeysSample.js.map