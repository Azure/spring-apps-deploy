...
function appsValidateDomain() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.apps.validateDomain(resourceGroupName, serviceName, appName, validatePayload);
        console.log(result);
    });
}
appsValidateDomain().catch(console.error);
//# sourceMappingURL=appsValidateDomainSample.js.map