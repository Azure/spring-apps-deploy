...
function customDomainsDelete() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.customDomains.beginDeleteAndWait(resourceGroupName, serviceName, appName, domainName);
        console.log(result);
    });
}
customDomainsDelete().catch(console.error);
//# sourceMappingURL=customDomainsDeleteSample.js.map