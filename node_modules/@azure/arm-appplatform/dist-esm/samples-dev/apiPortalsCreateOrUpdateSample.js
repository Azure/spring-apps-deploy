 ...
 */
function apiPortalsCreateOrUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.apiPortals.beginCreateOrUpdateAndWait(resourceGroupName, serviceName, apiPortalName, apiPortalResource);
        console.log(result);
    });
}
apiPortalsCreateOrUpdate().catch(console.error);
//# sourceMappingURL=apiPortalsCreateOrUpdateSample.js.map