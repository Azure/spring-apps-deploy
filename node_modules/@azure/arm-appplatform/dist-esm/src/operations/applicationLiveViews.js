...
export class ApplicationLiveViewsImpl {
    /**
    ...
    get(resourceGroupName, serviceName, applicationLiveViewName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serviceName, applicationLiveViewName, options }, getOperationSpec);
    }
    /**
...
//# sourceMappingURL=applicationLiveViews.js.map