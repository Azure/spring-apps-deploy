...
export class DeploymentsImpl {
    ...
    listPagingAll(resourceGroupName, serviceName, appName, options) {
        return __asyncGenerator(this, arguments, function* listPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listPagingPage(resourceGroupName, serviceName, appName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
    ...
    listForClusterPagingAll(resourceGroupName, serviceName, options) {
        return __asyncGenerator(this, arguments, function* listForClusterPagingAll_1() {
            var e_2, _a;
            try {
                for (var _b = __asyncValues(this.listForClusterPagingPage(resourceGroupName, serviceName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield __await(yield* __asyncDelegator(__asyncValues(page)));
                }
            }
    ...
    _list(resourceGroupName, serviceName, appName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serviceName, appName, options }, listOperationSpec);
    }
    /**
     * List deployments for a certain service
     * @param resourceGroupName The name of the resource group that contains the resource. You can obtain
    ...
    _listNext(resourceGroupName, serviceName, appName, nextLink, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serviceName, appName, nextLink, options }, listNextOperationSpec);
    }
    /**
     * ListForClusterNext
     * @param resourceGroupName The name of the resource group that contains the resource. You can obtain
