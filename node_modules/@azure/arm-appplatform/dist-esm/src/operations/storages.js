...
export class StoragesImpl {
    ...
    get(resourceGroupName, serviceName, storageName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serviceName, storageName, options }, getOperationSpec);
    }
    /**
    ...
    beginCreateOrUpdate(resourceGroupName, serviceName, storageName, storageResource, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, serviceName, storageName, storageResource, options }, createOrUpdateOperationSpec);
    ...
    beginDelete(resourceGroupName, serviceName, storageName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, serviceName, storageName, options }, deleteOperationSpec);
            const poller = new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs
            });
