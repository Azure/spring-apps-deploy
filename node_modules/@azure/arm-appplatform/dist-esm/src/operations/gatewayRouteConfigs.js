...
export class GatewayRouteConfigsImpl {
    /**
    ...
    get(resourceGroupName, serviceName, gatewayName, routeConfigName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serviceName, gatewayName, routeConfigName, options }, getOperationSpec);
    }
    /**
    ...
    beginDelete(resourceGroupName, serviceName, gatewayName, routeConfigName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, serviceName, gatewayName, routeConfigName, options }, deleteOperationSpec);
            const poller = new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs
            });
...
//# sourceMappingURL=gatewayRouteConfigs.js.map