...
export class CustomizedAcceleratorsImpl {
    /**
    ...
    listPagingPage(resourceGroupName, serviceName, applicationAcceleratorName, options, settings) {
        return __asyncGenerator(this, arguments, function* listPagingPage_1() {
            ...
            if (!continuationToken) {
                result = yield __await(this._list(resourceGroupName, serviceName, applicationAcceleratorName, options));
            ...
            while (continuationToken) {
                result = yield __await(this._listNext(resourceGroupName, serviceName, applicationAcceleratorName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listPagingAll(resourceGroupName, serviceName, applicationAcceleratorName, options) {
        return __asyncGenerator(this, arguments, function* listPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listPagingPage(resourceGroupName, serviceName, applicationAcceleratorName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
...
//# sourceMappingURL=customizedAccelerators.js.map