...
export class DevToolPortalsImpl {
    /**
    ...
    get(resourceGroupName, serviceName, devToolPortalName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serviceName, devToolPortalName, options }, getOperationSpec);
    }
    /**
...
//# sourceMappingURL=devToolPortals.js.map