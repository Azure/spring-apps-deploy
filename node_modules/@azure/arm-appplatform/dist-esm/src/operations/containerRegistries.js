...
export class ContainerRegistriesImpl {
    /**
    ...
    get(resourceGroupName, serviceName, containerRegistryName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serviceName, containerRegistryName, options }, getOperationSpec);
    }
    /**
