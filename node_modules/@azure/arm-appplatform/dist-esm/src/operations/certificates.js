...
export class CertificatesImpl {
    ...
    get(resourceGroupName, serviceName, certificateName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serviceName, certificateName, options }, getOperationSpec);
    }
    /**
    ...
    beginDelete(resourceGroupName, serviceName, certificateName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, serviceName, certificateName, options }, deleteOperationSpec);
            const poller = new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs
            });
