...
export class ConfigurationServicesImpl {
    /**
    ...
    get(resourceGroupName, serviceName, configurationServiceName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serviceName, configurationServiceName, options }, getOperationSpec);
    }
    /**
...
//# sourceMappingURL=configurationServices.js.map