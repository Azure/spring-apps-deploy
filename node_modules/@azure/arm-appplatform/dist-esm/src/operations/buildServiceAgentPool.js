...
export class BuildServiceAgentPoolImpl {
    /**
    ...
    listPagingAll(resourceGroupName, serviceName, buildServiceName, options) {
        return __asyncGenerator(this, arguments, function* listPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listPagingPage(resourceGroupName, serviceName, buildServiceName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
    ...
    _list(resourceGroupName, serviceName, buildServiceName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serviceName, buildServiceName, options }, listOperationSpec);
    }
    /**
    ...
    _listNext(resourceGroupName, serviceName, buildServiceName, nextLink, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serviceName, buildServiceName, nextLink, options }, listNextOperationSpec);
    }
}
...
//# sourceMappingURL=buildServiceAgentPool.js.map