...
Inputs.REGISTRY_SERVER = 'registry-server';
Inputs.REGISTRY_USERNAME = 'registry-username';
Inputs.REGISTRY_PASSWORD = 'registry-password';
Inputs.IMAGE_NAME = 'image-name';
Inputs.IMAGE_COMMAND = 'image-command';
Inputs.IMAGE_ARGS = 'image-args';
Inputs.IMAGE_LANGUAGE_FRAMEWORK = 'image-language-framework';
class Actions {
}
