...
class AzureSpringAppsDeploymentProvider {
    ...
    deployAppStep() {
        return __awaiter(this, void 0, void 0, function* () {
            switch (this.params.action) {
                ...
                case ActionParameters_1.Actions.BUILD: {
                    yield this.performBuildAction();
                    break;
                }
                case ActionParameters_1.Actions.DELETE_BUILD: {
                    yield this.performDeleteBuildAction();
                    break;
                }
                default:
    ...
    performDeployAction() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let fileToUpload;
            if (sourceType != exports.SourceType.CUSTOM_CONTAINER) {
                fileToUpload = sourceType == exports.SourceType.SOURCE_DIRECTORY
            ...
            if (sourceType == exports.SourceType.CUSTOM_CONTAINER) {
                yield DeploymentHelper_1.DeploymentHelper.deployCustomContainer(this.client, this.params, sourceType);
            }
                ...
                yield DeploymentHelper_1.DeploymentHelper.deployEnterprise(this.client, this.params, "BuildResult", fileToUpload, this.resourceId);
            }
            else {
    ...
    performBuildAction() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let fileToUpload = sourceType == exports.SourceType.SOURCE_DIRECTORY
                ? yield this.compressSourceDirectory(this.params.package.getPath())
                : this.params.package.getPath();
            yield DeploymentHelper_1.DeploymentHelper.build(this.client, this.params, fileToUpload, this.resourceId);
            console.log(`Build action successful for service ${this.params.serviceName} build ${this.params.buildName}.`);
        });
    }
    performDeleteBuildAction() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.tier != "Enterprise") {
                throw Error(`Delete build action is only supported in Enterprise tier.`);
            }
            yield DeploymentHelper_1.DeploymentHelper.deleteBuild(this.client, this.params);
    ...
    determineSourceType(pkg) {
        if (this.params.containerImage && this.params.containerRegistry) {
            return exports.SourceType.CUSTOM_CONTAINER;
        }
        var sourceType;
