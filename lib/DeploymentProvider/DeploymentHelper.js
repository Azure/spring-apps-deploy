...
class DeploymentHelper {
    ...
    static deployEnterprise(client, params, sourceType, fileToUpload, resourceId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const uploadResponse = yield client.buildServiceOperations.getResourceUploadUrl(params.resourceGroupName, params.serviceName, params.appName);
            core.debug('request upload url response: ' + JSON.stringify(uploadResponse));
            yield (0, azure_storage_1.uploadFileToSasUrl)(uploadResponse.uploadUrl, fileToUpload);
            ...
            const buildResponse = yield client.buildServiceOperations.createOrUpdateBuild(params.resourceGroupName, params.serviceName, "default", params.appName, build);
            core.debug('build response: ' + JSON.stringify(buildResponse));
            const waitResponse = yield client.buildServiceOperations.getBuildResult(params.resourceGroupName, params.serviceName, "default", params.appName, buildResponse.properties.triggeredBuildResult.id);
