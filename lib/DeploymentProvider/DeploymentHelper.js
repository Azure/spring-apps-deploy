...
class DeploymentHelper {
    ...
    static deploy(client, params, sourceType, fileToUpload) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.deployWithLog(client, params, deploymentResource);
            return;
        });
    }
    ...
    static logStreamConstructor(client, params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const serviceResponse = yield client.services.get(params.resourceGroupName, params.serviceName);
    ...
    static printLatestAppInstanceLog(client, params) {
        return __awaiter(this, void 0, void 0, function* () {
            const logStream = yield this.logStreamConstructor(client, params);
            const deploymentResource = yield client.deployments.get(params.resourceGroupName, params.serviceName, params.appName, params.deploymentName);
            ...
            (0, node_fetch_1.default)(url, { method: 'GET', headers: auth })
                .then(response => {
                if (response.ok) {
    ...
    static deployWithLog(client, params, deploymentResource) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield this.printLatestAppInstanceLog(client, params);
                throw e;
            }
        });
    }
