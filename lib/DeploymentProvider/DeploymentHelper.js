...
class DeploymentHelper {
    ...
    static deployEnterprise(client, params, sourceType, fileToUpload, resourceId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const buildResponse = yield client.buildServiceOperations.createOrUpdateBuild(params.resourceGroupName, params.serviceName, buildServiceName, params.appName, build);
            core.debug('build response: ' + JSON.stringify(buildResponse));
            const waitResponse = yield client.buildServiceOperations.getBuildResult(params.resourceGroupName, params.serviceName, buildServiceName, params.appName, buildResponse.properties.triggeredBuildResult.id);
